...
const Home = () => {
    const news = [
        ...
        },
        {
          ...
          description: "Private funding by VC firms is down 50% YOY, We tahe a look at what that means.",
        },
      ];
        ...
        <div className="infos">
          ...
          <div className="more-info">
            <p>
              ...
              power of the platforms back ito the hads of the people. But is it
